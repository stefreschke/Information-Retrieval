...
\begin{itemize}
	...
	\item Operator: Dieses Modul exportiert effiziente Funktionen, die den eigentlich Operatoren von Python entsprechen. Es findet nur Anwendung in der Sortierung der zu zurückgebenden Dokumente in der retrieve-Methode
